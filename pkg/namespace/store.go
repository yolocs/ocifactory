...
const (
	...
	// "namespace-index". Operators with a shared OCI registry can group
	// everything under their own prefix via [WithPrefix].
	DefaultPrefix = ""

	indexRepoSegment  = "namespace-index"
...
// at top-level "namespace-index" with one tag per namespace. Distribution's
